...
VALUES ('https://img.championat.com/s/1350x900/news/big/x/k/zenit-luchshaya-komanda-rpl-.jpg'),
       ('https://sun9-75.userapi.com/impf/c831309/v831309474/889f8/iUXCYWkLfl4.jpg?size=928x670&quality=96&sign=df483e9f95ff95d5578f81c16c61493b&c_uniq_tag=wDWXY-faSbAIQ4TWkp-XuPVmWzLGLlzwQafwIkHK-mg&type=album'),
       ...
       ('https://wallpapercg.com/media/ts_orig/18750.webp');
...
Переведут ли игру на русский язык — достоверно неизвестно. Вместе с тем в трейлере можно включить русские субтитры, а на официальном сайте Rockstar Games появилась русскоязычная страница c роликом.',
        (SELECT id FROM picture WHERE url = 'https://wallpapercg.com/media/ts_orig/18750.webp'));
...
По словам синоптика, 5 января рекордов уже не ожидается. Самая низкая температура в этот день была зафиксирована в 1950 году -28,9 градуса.',
        (SELECT id FROM picture WHERE url = 'https://sun9-75.userapi.com/impf/c831309/v831309474/889f8/iUXCYWkLfl4.jpg?size=928x670&quality=96&sign=df483e9f95ff95d5578f81c16c61493b&c_uniq_tag=wDWXY-faSbAIQ4TWkp-XuPVmWzLGLlzwQafwIkHK-mg&type=album'));
